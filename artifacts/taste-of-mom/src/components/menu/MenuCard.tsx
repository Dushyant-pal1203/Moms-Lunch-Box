...
export function MenuCard({ item, index, inView = true }: MenuCardProps) {
  ...
  return (
    <div
      ...
      className={`group bg-card border border-card-border rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 flex flex-col ${
